...
def find_truth_source(project_root: Path | None = None) -> Path | None:
    ...
    The final-suite viewer now routes truth with ``truth_source_for_task``.
    This helper remains for older callers/tests and returns only the hard-coded
    multispecies projection when it is present.
    """
    del project_root
