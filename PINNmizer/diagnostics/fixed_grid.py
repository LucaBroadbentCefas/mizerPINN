...
def compute_fixed_diagnostics(
    *,
    ...
    row = {
        ...
        "fixed_residual_reference_scaled_rms": _rms(out["residual_reference_scaled"]),
        "fixed_residual_reference_scaled_abs_mean": _abs_mean(out["residual_reference_scaled"]),
        "fixed_residual_reference_scaled_abs_p95": _abs_p95(out["residual_reference_scaled"]),
        "fixed_residual_reference_scaled_abs_max": _abs_max(out["residual_reference_scaled"]),
        "fixed_reference_scale_min": _min(out["reference_scale_eval"]),
        "fixed_reference_scale_max": _max(out["reference_scale_eval"]),
        "fixed_N_over_reference_scale_min": _min(out["N_over_reference_scale"]),
        "fixed_N_over_reference_scale_mean": _as_float(torch.mean(out["N_over_reference_scale"].detach())),
        "fixed_N_over_reference_scale_abs_p95": _abs_p95(out["N_over_reference_scale"]),
        "fixed_N_over_reference_scale_max": _max(out["N_over_reference_scale"]),
