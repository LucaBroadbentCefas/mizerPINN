#!/bin/bash
#SBATCH --job-name=pinn_state_u_repeat_tests
...
RUN_NAMES=(
  "u_fourier_s05_logbc_adaptive_q3_control"
  "u_fourier_s025_logbc_adaptive_q3"
  "u_fourier_s10_logbc_adaptive_q3"
  "u_fourier_s05_logbc_noadaptive_q3"
  "u_mlp_logbc_adaptive_q3"
  "u_fourier_s05_relativebc_adaptive_q3"
  "u_fourier_s05_logbc_noadaptive_q1_long100k"
)
...
# For adaptive runs:
#   effective initial BC coefficient = lambda_bc * initial_w_bc
#                                    = 1.0 * 0.1
#
# For non-adaptive runs initial_w_bc is ignored, so lambda_bc is set to 0.1.
LAMBDA_BCS=(
  "1.0"
  "1.0"
  "1.0"
...
# -------------------------------------------------------------------------
# Create run-specific t_max = 30 fixture
# -------------------------------------------------------------------------
...
echo "boundary_loss_form=${BOUNDARY_LOSS_FORM}"
echo "loss_weighting=${LOSS_WEIGHTING}"
echo "lambda_bc=${LAMBDA_BC}"
...
# Avoid all array tasks performing initial file reads simultaneously.
sleep $((RUN_ID * 5))
